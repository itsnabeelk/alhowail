...
YoutubeBackground.prototype.buildHTML = function () {
    ...
    wrapper.className = 'youtube-background video-container a-video';

 

  var divtest = document.createElement("div");
    divtest.className = "overlay";
    wrapper.appendChild(divtest);
	...
	if (this.params['load-background']) {
		...
		wrapper_styles['background-image'] = 'url(images/bg-history.jpg)';
